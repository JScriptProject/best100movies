...
export default async function Home({ searchParams }: HomeProps) {
  ...
  return (
    <main className="container mx-auto px-4 pb-20 space-y-12">
      ...
      <div className="main-page-header hidden md:block"></div>
      <div className="text-center pt-16 mb-8 space-y-4 ">
        <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-white">
          Best <span className="text-red-600">100</span> Movies
        </h1>
        <p className="text-gray-400 max-w-2xl mx-auto text-lg">
          Curated lists of the absolute best films. Updated daily for the true
          cinema lover.
        </p>
